...
public abstract class MyAbstractCameraActivity extends AppCompatActivity {
    /**
     ...
     */
    abstract protected MyCameraFragment buildFragment();
    ...
    protected static final String TAG_CAMERA=MyCameraFragment.class.getCanonicalName();
    private static final int REQUEST_PERMS=13401;
    protected MyCameraFragment cameraFrag;
    ...
    protected void init() {
        cameraFrag= (MyCameraFragment) getSupportFragmentManager().findFragmentByTag(TAG_CAMERA);
    ...
    abstract public static class IntentBuilder<T extends MyAbstractCameraActivity.IntentBuilder> {
        ...
        public T quality(AbstractCameraActivity.Quality q) {
            result.putExtra(MediaStore.EXTRA_VIDEO_QUALITY, Quality.HIGH);
