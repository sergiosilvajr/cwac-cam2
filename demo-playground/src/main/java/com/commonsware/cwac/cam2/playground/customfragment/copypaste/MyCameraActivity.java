 ...
 */
public class MyCameraActivity extends MyAbstractCameraActivity
  ...
  @Override
  protected MyCameraFragment buildFragment() {
    return(MyCameraFragment.newPictureInstance(getOutputUri(),
  ...
  public static class IntentBuilder
    extends MyAbstractCameraActivity.IntentBuilder<IntentBuilder> {
    /**
    ...
    public IntentBuilder(Context ctxt) {
      super(ctxt, MyCameraActivity.class);
    }
